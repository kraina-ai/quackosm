...
- Migrated `pdm.lock` file to a new `pylock.toml` format

## [0.15.2] - 2025-07-01

### Removed

- `python-geohash` from dependencies
...
[Unreleased]: https://github.com/kraina-ai/quackosm/compare/0.16.1...HEAD
...
[0.15.2]: https://github.com/kraina-ai/quackosm/compare/0.15.1...0.15.2
